Component({
    ...
    changePro: function (e) {
      const cities = this.data.china[e.currentTarget.dataset.pro]
      this.setData({
        cities: cities,
        proName: e.currentTarget.dataset.pro
      })
    },
